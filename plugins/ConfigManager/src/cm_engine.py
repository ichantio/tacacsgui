...
class cm_engine():
    ...
    def run(self, **parms):
        ...
        known_hosts = "/opt/tgui_data/confManager/known_hosts"
	...
	###	SSH EXPECT AUTHENTICATION	###
            ...
            child = pexpect.spawn('ssh -tt -oUserKnownHostsFile='+known_hosts+' -oStrictHostKeyChecking=no -p '+port+' -o ConnectTimeout=10 '+username+'@'+hostname, encoding='utf8')
