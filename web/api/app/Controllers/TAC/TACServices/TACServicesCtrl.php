...
########	Add New Service	###############START###########
	...
	public function postServiceAdd($req,$res)
	{
		...
		$cisco_rs_cmd = isset($allParams['cisco_rs_cmd']) && is_array($allParams['cisco_rs_cmd']) ? $allParams['cisco_rs_cmd'] : [];
		$h3c_cmd = isset($allParams['h3c_cmd']) && is_array($allParams['h3c_cmd']) ? $allParams['h3c_cmd'] : [];
		$huawei_cmd = isset($allParams['huawei_cmd']) && is_array($allParams['huawei_cmd']) ? $allParams['huawei_cmd'] : [];
		$extreme_cmd = isset($allParams['extreme_cmd']) && is_array($allParams['extreme_cmd']) ? $allParams['extreme_cmd'] : [];
		$junos_cmd_ao = isset($allParams['junos_cmd_ao']) && is_array($allParams['junos_cmd_ao']) ? $allParams['junos_cmd_ao'] : [];
		$junos_cmd_do = isset($allParams['junos_cmd_do']) && is_array($allParams['junos_cmd_do']) ? $allParams['junos_cmd_do'] : [];
		$junos_cmd_ac = isset($allParams['junos_cmd_ac']) && is_array($allParams['junos_cmd_ac']) ? $allParams['junos_cmd_ac'] : [];
		$junos_cmd_dc = isset($allParams['junos_cmd_dc']) && is_array($allParams['junos_cmd_dc']) ? $allParams['junos_cmd_dc'] : [];
